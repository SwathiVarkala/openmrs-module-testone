 ...
 */
package org.openmrs.module.testone.web.controller;
 ...
 * 'module/testone/testoneLink.form'.
 */
@Controller
@RequestMapping(value = "module/testone/testoneLink.form")
public class TestoneFormController {
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/testone/testoneForm";
